...
class InstagramLoader
	class << self
		def photos()
			...
			client = Instagram.client(:access_token => "15460775.2d11c43.ff37bb6d3f944af4971a7bfe4b9dd17c")
...
module Jekyll
  class InstagramTag < Liquid::Block
    ...
    def initialize(tag_name, markup, tokens)
      ...
      @accesstoken = "15460775.2d11c43.ff37bb6d3f944af4971a7bfe4b9dd17c"
      @name = 'item'
    ...
    def render(context)
	  ...
	  collection = InstagramLoader.photos()
